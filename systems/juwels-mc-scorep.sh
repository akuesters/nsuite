...
module use /p/scratch/share/ScalingWorkshop/JUWELS/mf
module load Score-P/trunk-gcc-parastation

# a switch for the build_arbor.sh script
export USE_SCOREP=true
